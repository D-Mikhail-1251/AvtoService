<?php $__env->startSection('main'); ?>
    ...
    <section class="py-3 py-md-5" >
        <div class="container" style="display: flex; flex-direction: column;justify-content: center; align-items: center; gap: 50px">
            <div class="row gy-3 gy-md-4 gy-lg-0 align-items-lg-center">
                <div class="col-12 col-lg-6 col-xl-5">
                    <img class="img-fluid rounded" loading="lazy" src="<?php echo e(asset('images/2.jpg')); ?>" alt="About 1">
                </div>
                            ...
                            <div class="row gy-4 gy-md-0 gx-xxl-5X">
                                <div class="col-12 col-md-6">
                                    <div class="d-flex">
                                        ...
                                        <div>
                                            <h2 class="h4 mb-3">За качество отвечаем</h2>
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="d-flex">
                                        ...
                                        <div>
                                            <h2 class="h4 mb-3">Передовые технологии</h2>
                            ...
                            <div class="row gy-4 gy-md-0 gx-xxl-5X">
                                <div class="col-12 col-md-6">
                                    <div class="d-flex">
                                        ...
                                        <div>
                                            <h2 class="h4 mb-3">Полное обслуживание</h2>
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="d-flex">
                                        ...
                                        <div>
                                            <h2 class="h4 mb-3">Удобство записи</h2>
...
<?php echo $__env->make('layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Danger_Mihail\Servak\AvtoService\resources\views/pages/about.blade.php ENDPATH**/ ?>